...
<body>
    <div class="container">
        ...
        <div class="header fade-in">
            ...
            <p>Guía completa para administradores del sistema Web Codigos 5.1</p>
        </div>

        <!-- Tabla de Contenidos -->
        <div class="section fade-in" id="contenido">
            <h2 class="section-title">
                <i class="bi bi-list-ol"></i>
                Tabla de Contenidos
            </h2>
            <ol>
                <li><a href="#dashboard">Dashboard del Sistema</a></li>
                <li><a href="#opciones-principales">Opciones Principales</a></li>
                <li><a href="#performance">Performance</a></li>
                <li><a href="#personalizacion">Personalización del Sitio</a></li>
                <li><a href="#servidores">Configuración de Servidores IMAP</a></li>
                <li><a href="#usuarios">Gestión de Usuarios</a></li>
                <li><a href="#registros">Registros del Sistema</a></li>
                <li><a href="#correos">Correos Autorizados</a></li>
                <li><a href="#plataformas">Gestión de Plataformas</a></li>
                <li><a href="#asignar-correos">Asignar Correos por Usuario</a></li>
                <li><a href="#bot-telegram">Bot de Telegram</a></li>
                <li><a href="#licencia">Licencia y Migración</a></li>
            </ol>
        </div>
        ...
        <div class="section fade-in" id="dashboard">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Ingresa al panel y selecciona <strong>Dashboard</strong>.</li>
                    <li>Observa consultas del día, usuarios activos y servidores operativos.</li>
                    <li>Monitorea las métricas que se actualizan cada 30 segundos.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="opciones-principales">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Accede a <strong>Opciones Principales</strong> desde el panel.</li>
                    <li>Activa o desactiva filtros como autenticación, restricciones y cache.</li>
                    <li>Guarda los cambios para aplicar la configuración.</li>
                </ol>
            </div>
            ...
            <div class="subsection">
                ...
                <div class="config-item">
                    <div class="config-name">USER_SUBJECT_RESTRICTIONS_ENABLED - Restricciones de Asuntos</div>
                    <div class="config-description">
                        <strong>Función:</strong> Limita qué asuntos puede consultar cada usuario en cada plataforma.
                        <br><strong>Activado (1):</strong> Se deben asignar asuntos específicos por usuario y plataforma.
                        <br><strong>Desactivado (0):</strong> Todos los asuntos estarán disponibles para todos los usuarios.
                    </div>
                    <div class="config-example">Recomendación: Activar para un control granular de búsquedas.</div>
                </div>
        ...
        <div class="section fade-in" id="performance">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Ingresa a <strong>Performance</strong> para optimizar el sistema.</li>
                    <li>Ajusta opciones avanzadas como búsqueda precisa y parada temprana.</li>
                    <li>Configura límites y tiempos adecuados y guarda los cambios.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="personalizacion">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Establece títulos y enlaces globales desde esta sección.</li>
                    <li>Configura opciones de contacto como WhatsApp o enlaces externos.</li>
                    <li>Sube un logo PNG de 150x150px en <code>images/logo/</code>.</li>
                </ol>
            </div>
            ...
            <div class="subsection">
                ...
                <div class="config-item">
                    ...
                    <div class="config-description">
                        ...
                        <strong>Dimensiones exactas:</strong> 150px × 150px (alineado con styles/modern_inicio.css)<br>
                        <strong>Ubicación de almacenamiento:</strong> Carpeta images/logo/<br>
        ...
        <div class="section fade-in" id="servidores">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Accede a la sección <strong>Servidores</strong> desde el panel.</li>
                    <li>Introduce host, puerto, usuario y contraseña del servidor IMAP.</li>
                    <li>Usa <em>Probar conexión</em> para validar la configuración.</li>
                    <li>Guarda el servidor solo si la prueba es exitosa.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="usuarios">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Entra a <strong>Gestión de Usuarios</strong> en el panel.</li>
                    <li>Crea o edita usuarios con nombre y contraseña seguros.</li>
                    <li>Define permisos, correos y asuntos permitidos.</li>
                    <li>Guarda cambios y activa o desactiva usuarios según sea necesario.</li>
                </ol>
            </div>
            ...
            <div class="text-end" style="margin-top: 15px;">
                <a href="admin.php" class="btn-return"><i class="bi bi-arrow-up-circle"></i> Volver al Panel</a>
            </div>
        </div>
        ...
        <div class="section fade-in" id="registros">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Abre <strong>Registros</strong> desde el panel de administración.</li>
                    <li>Elige el tipo de registro y aplica filtros de fecha o usuario.</li>
                    <li>Revisa la información y exporta los datos si necesitas un respaldo.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="correos">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Ingresa a <strong>Correos Autorizados</strong> desde el menú.</li>
                    <li>Agrega direcciones individualmente o importa listas masivas.</li>
                    <li>Utiliza la barra de búsqueda para validar o editar entradas.</li>
                    <li>Guarda los cambios para actualizar la lista autorizada.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="plataformas">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Abre <strong>Plataformas</strong> en el panel.</li>
                    <li>Presiona <strong>Agregar Plataforma</strong> y define nombre y criterios.</li>
                    <li>Opcionalmente sube un logo y asigna asuntos de búsqueda.</li>
                    <li>Guarda los cambios para hacerla disponible.</li>
                </ol>
            </div>
            ...
            <details class="subsection">
                <summary>Operaciones con Plataformas</summary>
            ...
            <div class="subsection">
                <h3>Logos de la Plataforma</h3>

                <div class="config-item">
                    <div class="config-name">Subir Logo PNG</div>
                    <div class="config-description">
                        En el formulario de creación o edición puedes subir un archivo PNG que represente a la plataforma. Este logo será almacenado junto a su configuración.
                    </div>
                </div>

                <div class="config-item">
                    <div class="config-name">Previsualización y Eliminación</div>
                    <div class="config-description">
                        Tras seleccionar el archivo, el sistema muestra una vista previa del logo y ofrece la opción de eliminarlo antes de guardar los cambios.
                    </div>
                </div>

                <div class="config-item">
                    <div class="config-name">Uso del Logo en el Panel</div>
                    <div class="config-description">
                        Una vez guardado, el logo se muestra como un ícono pequeño en el listado de plataformas del panel. Al elegir una plataforma, el logo del sitio se actualiza automáticamente con la imagen correspondiente.
                    </div>
                </div>
            </div>
        ...
        <div class="section fade-in" id="asignar-correos">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Activa las restricciones en <strong>Opciones Principales</strong>.</li>
                    <li>Selecciona el usuario al que deseas asignar correos.</li>
                    <li>Define las direcciones y asuntos permitidos para ese usuario.</li>
                    <li>Guarda la configuración para aplicar los cambios.</li>
                </ol>
            </div>
            ...
            <div class="subsection">
                ...
                <div class="config-item">
                    ...
                    <div class="config-description">
                        Primero activa "USER_EMAIL_RESTRICTIONS_ENABLED" y "USER_SUBJECT_RESTRICTIONS_ENABLED" en la sección "Opciones Principales" de Configuración.
                    </div>
                </div>
        ...
        <div class="section fade-in" id="bot-telegram">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Obtén el token de tu bot mediante <strong>BotFather</strong>.</li>
                    <li>Ingresa el token y la URL del webhook en esta sección.</li>
                    <li>Activa el bot y registra el webhook para recibir mensajes.</li>
                    <li>Configura límites y monitorea la actividad desde el panel.</li>
                </ol>
            </div>
        ...
        <div class="section fade-in" id="licencia">
            ...
            <div class="subsection">
                <h3>Pasos rápidos</h3>
                <ol>
                    <li>Accede a <strong>Licencia</strong> para revisar el estado actual.</li>
                    <li>Respalda archivos y base de datos antes de migrar a otro servidor.</li>
                    <li>Tras la migración, actualiza configuraciones y solicita reactivación al proveedor.</li>
                </ol>
            </div>

            <div class="subsection">
                <h3>Verificación de Licencia</h3>
                <p>Esta sección permite verificar que tu dominio esté correctamente activado y autorizado para usar el sistema Web Codigos 5.1.</p>
                ...
                <div class="config-item">
                    <div class="config-name">Banner de bloqueo</div>
                    <div class="config-description">
                        Si la validación falla, el sistema despliega un banner que impide su uso.<br>
                        Incluye el botón <strong>Revisar licencia</strong> que ejecuta <code>manual_license_check.php</code>; si el estado vuelve a "active", el sistema se libera.<br>
                        También ofrece un campo para ingresar una nueva clave, la cual se envía a <code>renovar_licencia.php</code> para revalidar cuando la verificación no se completa.
                    </div>
                </div>
            ...
            <details class="subsection">
                <summary>Proceso de Migración a Otro Servidor</summary>
        ...
        <div class="nav-buttons">
            <a href="#dashboard" class="nav-btn" title="Dashboard" data-tooltip="Dashboard">
                <i class="bi bi-speedometer2"></i>
            </a>
            <a href="#opciones-principales" class="nav-btn" title="Opciones" data-tooltip="Opciones">
                <i class="bi bi-toggles"></i>
            </a>
            <a href="#performance" class="nav-btn" title="Performance" data-tooltip="Performance">
                <i class="bi bi-rocket-takeoff"></i>
            </a>
            <a href="#personalizacion" class="nav-btn" title="Personalización" data-tooltip="Personalización">
                <i class="bi bi-palette-fill"></i>
            </a>
            <a href="#servidores" class="nav-btn" title="Servidores" data-tooltip="Servidores">
                <i class="bi bi-server"></i>
            </a>
            <a href="#usuarios" class="nav-btn" title="Usuarios" data-tooltip="Usuarios">
                <i class="bi bi-people-fill"></i>
            </a>
            <a href="#registros" class="nav-btn" title="Registros" data-tooltip="Registros">
                <i class="bi bi-journal-text"></i>
            </a>
            <a href="#correos" class="nav-btn" title="Correos" data-tooltip="Correos">
                <i class="bi bi-envelope-check-fill"></i>
            </a>
            <a href="#plataformas" class="nav-btn" title="Plataformas" data-tooltip="Plataformas">
                <i class="bi bi-layers-fill"></i>
            </a>
            <a href="#asignar-correos" class="nav-btn" title="Asignar" data-tooltip="Asignar">
                <i class="bi bi-person-lines-fill"></i>
            </a>
            <a href="#bot-telegram" class="nav-btn" title="Bot Telegram" data-tooltip="Bot Telegram">
                <i class="bi bi-telegram"></i>
            </a>
            <a href="#licencia" class="nav-btn" title="Licencia" data-tooltip="Licencia">
                <i class="bi bi-shield-check"></i>
            </a>
        </div>
    </div>
